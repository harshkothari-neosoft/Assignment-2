...
let errornode1=document.getElementById("error");

let emailnode=document.getElementById("mail");
let errornode2=document.getElementById("error");

let contactnode=document.getElementById("contact");
let errornode3=document.getElementById("error");

let feedbacknode=document.getElementById("feedback");
let errornode4=document.getElementById("error");
